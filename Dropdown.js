...
class Dropdown extends HTMLElement {
  constructor() {
    ...
    this.$button = this._ropdownRoot.querySelector('d-button');
  ...
  attributeChangedCallback(name, oldVal, newVal) {
    console.log(name, oldVal, newVal,'name, oldVal, newVal165165')
    this.render();
  }
...
window.customElements.define('d-dropdown', Dropdown); // 注册d-dropdown组件